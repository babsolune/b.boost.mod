...
class WikiTrackedItemsController extends DefaultModuleController
{
	...
	private function generate_response(HTTPRequestCustom $request)
	{
		...
		$graphical_environment->get_seo_meta_data()->set_description(StringVars::replace_vars($this->lang['wiki.seo.description.tracked'], array('author' => AppContext::get_current_user()->get_display_name())), $page);
