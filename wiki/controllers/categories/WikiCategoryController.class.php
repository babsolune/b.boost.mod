...
class WikiCategoryController extends DefaultModuleController
{
	...
	private function generate_response(HTTPRequestCustom $request)
	{
		...
		if (empty($description))
			$description = StringVars::replace_vars($this->lang['wiki.seo.description.root'], array('site' => GeneralConfig::load()->get_site_name())) . ($this->get_category()->get_id() != Category::ROOT_CATEGORY ? ' ' . $this->lang['category.category'] . ' ' . $this->get_category()->get_name() : '');
