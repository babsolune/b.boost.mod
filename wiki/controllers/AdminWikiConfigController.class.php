...
class AdminWikiConfigController extends DefaultAdminModuleController
{
	...
	private function build_form()
	{
        ...
        $fieldset->add_field(new FormFieldSimpleSelectChoice('homepage', $this->lang['wiki.homepage'], $this->config->get_homepage(),
			array(
				new FormFieldSelectChoiceOption($this->lang['wiki.config.root'], WikiConfig::CATEGORIES, array('data_option_icon' => 'fa fa-th-large')),
				new FormFieldSelectChoiceOption($this->lang['wiki.config.explorer'], WikiConfig::EXPLORER, array('data_option_icon' => 'fa fa-list')),
				new FormFieldSelectChoiceOption($this->lang['wiki.config.overview'], WikiConfig::OVERVIEW, array('data_option_icon' => 'fa fa-grid')),
			)
        ));
		...
		$fieldset->add_field(new FormFieldSimpleSelectChoice('display_type', $this->lang['form.display.type'], $this->config->get_display_type(),
			array(
				new FormFieldSelectChoiceOption($this->lang['form.display.type.grid'], WikiConfig::GRID_VIEW, array('data_option_icon' => 'fa fa-th-large')),
				new FormFieldSelectChoiceOption($this->lang['form.display.type.list'], WikiConfig::LIST_VIEW, array('data_option_icon' => 'fa fa-list')),
				new FormFieldSelectChoiceOption($this->lang['form.display.type.table'], WikiConfig::TABLE_VIEW, array('data_option_icon' => 'fa fa-table'))
			),
			array(
				'select_to_list' => true,
				'events' => array('change' => '
