...
class WikiItemsManagerController extends DefaultModuleController
{
	...
	private function build_table()
	{
		...
		foreach ($result as $row)
		{
			...
			$row = array(
				new HTMLTableRowCell(new LinkHTMLElement(WikiUrlBuilder::display($category->get_id(), $category->get_rewrited_name(), $item->get_id(), $item->get_rewrited_title()), $item->get_item_content()->get_title()), 'left'),
