...
class ScmSeasonsManagerController extends DefaultModuleController
{
	...
	private function build_table()
	{
		$columns = [
			...
			new HTMLTableColumn('<a class="offload" href="' . ScmUrlBuilder::add_season()->rel() . '" aria-label="' . $this->lang['scm.add.season'] . '"><i class="far fa-2x fa-square-plus" aria-hidden="true"></i></a>', '', ['css_class' => 'bgc-full success'])
        ];
