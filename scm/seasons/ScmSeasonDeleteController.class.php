...
class ScmSeasonDeleteController extends DefaultModuleController
{
	public function execute(HTTPRequestCustom $request)
	{
		...
		ScmSeasonService::delete_season($season->get_id_season());
	...
	private function get_season(HTTPRequestCustom $request)
	{
		...
		{
			try {
				return ScmSeasonService::get_season($id);
