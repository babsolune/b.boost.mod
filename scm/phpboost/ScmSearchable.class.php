...
class ScmSearchable extends DefaultSearchable
{
	public function __construct()
	{
		$module_id = 'scm';
		parent::__construct($module_id);
		$this->read_authorization = ScmAuthorizationsService::check_authorizations()->read();

		$this->table_name = ScmSetup::$scm_event_table;

		$this->authorized_categories = CategoriesService::get_authorized_categories(Category::ROOT_CATEGORY, ScmConfig::load()->is_summary_displayed_to_guests(), $module_id);
