...
class ScmMiniPrevGame extends ModuleMiniMenu
{
	...
	public function get_menu_content()
	{
        ...
        {
            if (
                ($game['hat_ranking'] && $game['game_group'] == ScmGroupService::get_last_matchday_hat($game['game_event_id']))
                || (!$game['hat_ranking'] && $game['game_round'] == ScmGroupService::get_last_matchday_group($game['game_event_id']))
        ...
        {
            if (
                $game['game_group'] == ScmDayService::get_last_day($game['game_event_id']) // Select last match day
