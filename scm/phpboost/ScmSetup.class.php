...
class ScmSetup extends DefaultModuleSetup
{
	...
	private function create_scm_event_table()
	{
		$fields = [
			...
			'master_id'             => ['type' => 'integer', 'length' => 65, 'default' => 0],
			'sub_order'             => ['type' => 'integer', 'length' => 11, 'default' => 0],
	...
	private function create_scm_game_table()
	{
		$fields = [
			...
			'game_cluster'        => ['type' => 'integer', 'length' => 11],
			...
			'game_home_off_bonus' => ['type' => 'string', 'length' => 2],
			'game_home_def_bonus' => ['type' => 'string', 'length' => 2],
			'game_home_goals'     => ['type' => 'text', 'length' => 65000],
			...
			'game_away_goals'     => ['type' => 'text', 'length' => 65000],
			'game_away_def_bonus' => ['type' => 'string', 'length' => 2],
			'game_away_off_bonus' => ['type' => 'string', 'length' => 2],
	...
	private function create_scm_params_table()
	{
		$fields = [
			...
			'finals_type'       => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'rounds_number'     => ['type' => 'integer', 'length' => 11],
			...
			'playoff_prom'    => ['type' => 'integer', 'length' => 11, 'default' => 0],
			'playoff_releg'   => ['type' => 'integer', 'length' => 11, 'default' => 0],
			'relegation'      => ['type' => 'integer', 'length' => 11, 'default' => 0],
			'fairplay_yellow' => ['type' => 'integer', 'length' => 11, 'default' => 0],
			'fairplay_red'    => ['type' => 'integer', 'length' => 11, 'default' => 0],

			'ranking_crit_1'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_2'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_3'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_4'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_5'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_6'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_7'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_8'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_9'  => ['type' => 'string', 'length' => 255, 'default' => "''"],
			'ranking_crit_10' => ['type' => 'string', 'length' => 255, 'default' => "''"],
