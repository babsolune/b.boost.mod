	...
	public function get_template_vars()
	{
        ...
        return array_merge(
            ...
            [
                ...
                'GAME_CLUSTER'    => $this->game_cluster,
                ...
                'HOME_GENERAL_FORFEIT' => $this->game_home_id && ScmTeamService::get_team($this->game_home_id)->get_team_status() == ScmParams::FORFEIT,
                'AWAY_GENERAL_FORFEIT' => $this->game_away_id && ScmTeamService::get_team($this->game_away_id)->get_team_status() == ScmParams::FORFEIT,
