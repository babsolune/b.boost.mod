            ...
            # START blocks.sub_blocks.items #
                <div id="game-{blocks.sub_blocks.items.GAME_ID}" class="cell cell-game">
                    <div class="flex-between">
                        <div class="flex-between sm-width-pc-50 small align-center">
                            <time class="sm-width-pc-70 small cell-gap">{blocks.sub_blocks.items.GAME_DATE_HOUR_MINUTE}</time>
                            <div class="sm-width-pc-30 cell-gap modal-container" aria-label="{@scm.game.event.details}">
                        ...
                        # IF blocks.sub_blocks.items.C_STATUS #
                            <div class="sm-width-pc-50 smaller text-italic align-center bgc notice">{blocks.sub_blocks.items.STATUS}</div>
                        # ENDIF #
                    </div>
