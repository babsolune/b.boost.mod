...
class ModlistConfig extends AbstractConfigData
{
	...
	public function get_default_values()
	{
		return array(
			...
			self::ROOT_CATEGORY_DESCRIPTION => LangLoader::get_message('root_category_description', 'config', 'modlist'),
	 ...
	 * @return ModlistConfig
	 */
	public static function load()
	{
		return ConfigManager::load(__CLASS__, 'modlist', 'config');
	}
	...
	{
		ConfigManager::save('modlist', self::load(), 'config');
	}
}
?>
