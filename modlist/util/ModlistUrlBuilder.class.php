...
class ModlistUrlBuilder
{
	 ...
	 * @return Url
	 */
	public static function display_item($category_id, $rewrited_name_category, $id_itemlist, $rewrited_title, $page = 1)
	{
		$page = $page !== 1 ? $page . '/' : '';
		return DispatchManager::get_url(self::$dispatcher, '/' . $category_id . '-' . $rewrited_name_category . '/' . $id_itemlist . '-' .$rewrited_title . '/' . $page);
	}

	/**
	 * @return Url
	 */
	public static function display_items_comments($category_id, $rewrited_name_category, $id_itemlist, $rewrited_title)
	{
		return DispatchManager::get_url(self::$dispatcher, '/' . $category_id . '-' . $rewrited_name_category . '/' . $id_itemlist . '-' . $rewrited_title . '/#comments-list');
	}
