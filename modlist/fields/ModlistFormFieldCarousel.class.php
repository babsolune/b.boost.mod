<?php
/*##################################################
 *		      ModlistFormFieldCarousel.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModlistFormFieldCarousel extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modlist/fields/ModlistFormFieldCarousel.tpl');
		$tpl->add_lang(LangLoader::get('common'));
		$tpl->add_lang(LangLoader::get('common', 'modlist'));
