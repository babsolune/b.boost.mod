<?php
/*##################################################
 *		      ModlistFormFieldSelectSources.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModlistFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modlist/fields/ModlistFormFieldSelectSources.tpl');
