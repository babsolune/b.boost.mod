...
class FootballSetup extends DefaultModuleSetup
{
	...
	private function create_football_club_table()
	{
		$fields = array(
			...
			'club_country' => array('type' => 'string', 'length' => 255, 'notnull' => 0, 'default' => "''"),
			'club_league' => array('type' => 'string', 'length' => 255, 'notnull' => 0, 'default' => "''"),
	...
	private function create_football_match_table()
	{
		$fields = array(
			...
			'match_field' => array('type' => 'string', 'length' => 11),
			'match_number' => array('type' => 'string', 'length' => 11),
			'match_day_id' => array('type' => 'integer', 'length' => 11),
			'match_home_team_id' => array('type' => 'integer', 'length' => 11),
			'match_home_team_score' => array('type' => 'string', 'length' => 2),
			'match_visit_team_score' => array('type' => 'string', 'length' => 2),
			'match_visit_team_id' => array('type' => 'integer', 'length' => 11),
	...
	private function create_football_params_table()
	{
		$fields = array(
			...
			'sets_number' => array('type' => 'integer', 'length' => 11, 'default' => 0),
			'bonus' => array('type' => 'boolean', 'default' => 0),
			'favorite_team_id' => array('type' => 'integer', 'length' => 11, 'default' => 0),

			'is_sub_compet' => array('type' => 'boolean', 'default' => 0),
			'compet_master_id' => array('type' => 'integer', 'length' => 11, 'default' => 0),
			'sub_compet_rank' => array('type' => 'integer', 'length' => 11, 'default' => 0),
		);
		$options = array(
	...
	{
		$categories_file = PATH_TO_ROOT . '/football/data/categories.csv';
		...
		$clubs_file = PATH_TO_ROOT . '/football/data/clubs.csv';
