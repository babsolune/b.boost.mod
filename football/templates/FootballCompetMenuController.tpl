            ...
            # IF C_TOURNAMENT #
                # IF C_HAS_GROUP_PARAMS #
                    ...
                    # IF C_HAS_MATCHES #
                        ...
                        <li><a href="{U_RESULTS}" class="offload cssmenu-title" aria-label="{@football.menu.results}"><i class="fa fa-fw fa-0 small" aria-hidden="true"></i>-<i class="fa fa-fw fa-0 small" aria-hidden="true"></i></a></li>
                    # ENDIF #
                # ENDIF #
            # ELSE #
                # IF C_HAS_TEAMS #
                    <li><a href="{U_MATCHES}" class="offload cssmenu-title" aria-label="{@football.menu.matches}"><i class="fa fa-fw fa-people-arrows" aria-hidden="true"></i></a></li>
                    # IF C_HAS_MATCHES #<li><a href="{U_RESULTS}" class="offload cssmenu-title" aria-label="{@football.menu.results}"><i class="fa fa-fw fa-0 small" aria-hidden="true"></i>-<i class="fa fa-fw fa-0 small" aria-hidden="true"></i></a></li># ENDIF #
                # ENDIF #
            # ENDIF #
        </ul>
    </nav>
</div>
<h1 class="big align-right">{HEADER}</h1>
