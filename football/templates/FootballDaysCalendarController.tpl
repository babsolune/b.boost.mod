# INCLUDE MENU #
<article>
    <header><h2>{@football.days.results} {@football.day} {DAY}</h2></header>
    <div class="content">
        # IF C_HAS_MATCHES #
                ...
                <tbody>
                    # START matches #
                        <tr# IF matches.C_HAS_SCORE # class="has-score-color"# ENDIF #>
                            # IF NOT C_ONE_DAY #<td><span class="">{matches.MATCH_DATE_SHORT}</span></td># ENDIF #
                            <td>{matches.MATCH_DATE_HOUR_MINUTE}</td>
                            <td class="# IF matches.C_HOME_FAV #text-strong# ENDIF #">
                            ...
                            <td class="# IF matches.C_AWAY_FAV #text-strong# ENDIF #">
