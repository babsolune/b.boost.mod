...
class FootballMenuService
{
	...
	public static function build_compet_menu($compet_id, $round = 1)
	{
        ...
        $view->put_all(array(
            ...
            'U_ROUND_GROUPS' => FootballUrlBuilder::display_groups_rounds($compet_id)->rel(),
            ...
            'U_EDIT_DAYS_MATCHES' => FootballUrlBuilder::edit_days_matches($compet_id, 1)->rel(),
            ...
            'U_EDIT_BRACKET_MATCHES' => FootballUrlBuilder::edit_brackets_matches($compet_id, $bracket_round)->rel(),
        ));
    ...
    private static function compare_url($url)
    {
        ...
        // Rebuild the URL
        $newUrl = str_replace($parsedUrl['path'], $newPath, $url);
