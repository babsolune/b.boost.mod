	...
	public function get_template_vars()
	{
		...
		return array_merge(
			...
			array(
				...
				// Links
					// Params
				'U_TEAMS'   => FootballUrlBuilder::teams($this->id_compet)->rel(),
				'U_MATCHES' => FootballUrlBuilder::teams($this->id_compet)->rel(),
				'U_RESULTS' => FootballUrlBuilder::teams($this->id_compet)->rel(),
				'U_PARAMS'  => FootballUrlBuilder::params($this->id_compet)->rel(),
