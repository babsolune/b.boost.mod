	...
	private function save()
	{
        ...
        if (!FootballMatchService::has_matches($this->compet_id()) && $count_teams == FootballTeamService::get_teams_number($this->compet_id()))
        {
            if ($this->get_params()->get_hat_ranking())
                FootballGroupService::set_hat_days_matches($this->compet_id(), $this->get_params()->get_hat_days(), FootballTeamService::get_teams_number($this->compet_id()));
            else
                FootballGroupService::set_groups_matches($this->compet_id());
            FootballBracketService::set_bracket_matches($this->compet_id(), FootballParamsService::get_params($this->compet_id())->get_rounds_number());
        }
