...
$lang['default.itemcat.title'] = 'ModCat, un module générique pour PHPBoost ' . GeneralConfig::load()->get_phpboost_major_version();
$lang['default.itemcat.description'] = '';
$lang['default.itemcat.contents'] = 'Ce module a été conçu pour vous aider à créer des modules avec un affichage par catégories. <br />
...
<br />
Le nom du module à remplacer : <ul class="formatter-ul"><li class="formatter-li">Modcat</li><li class="formatter-li">modcat</li></ul>
Le nom de la classe à remplacer : <ul class="formatter-ul"><li class="formatter-li">Itemcat</li><li class="formatter-li">itemcat</li></ul>
<br />
