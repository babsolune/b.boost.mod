<?php
/*##################################################
 *		   ModcatAuthorizationsService.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatAuthorizationsService
{
	public $category_id;
	...
	{
		$auth = ModcatService::get_categories_manager()->get_heritated_authorizations($this->category_id, $bit, $mode);
