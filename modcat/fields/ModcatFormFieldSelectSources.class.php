<?php
/*##################################################
 *		      ModcatFormFieldSelectSources.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modcat/fields/ModcatFormFieldSelectSources.tpl');
