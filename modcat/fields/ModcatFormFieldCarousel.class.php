<?php
/*##################################################
 *		      ModcatFormFieldCarousel.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatFormFieldCarousel extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modcat/fields/ModcatFormFieldCarousel.tpl');
		$tpl->add_lang(LangLoader::get('common'));
		$tpl->add_lang(LangLoader::get('common', 'modcat'));
