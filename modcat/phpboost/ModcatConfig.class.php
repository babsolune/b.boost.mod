...
class ModcatConfig extends AbstractConfigData
{
	...
	public function get_default_values()
	{
		return array(
			...
			self::ROOT_CATEGORY_DESCRIPTION => LangLoader::get_message('root_category_description', 'config', 'modcat'),
	...
	{
		return ConfigManager::load(__CLASS__, 'modcat', 'config');
	}
	...
	{
		ConfigManager::save('modcat', self::load(), 'config');
	}
}
?>
