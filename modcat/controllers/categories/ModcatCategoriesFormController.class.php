<?php
/*##################################################
 *		   ModcatCategoriesFormController.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return ModcatUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
