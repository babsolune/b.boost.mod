...
class SandboxFormController extends ModuleController
{
	...
	private function build_form()
	{
		...
		$fieldset->add_field(new FormFieldAjaxSearchUserAutoComplete('search_user_completition', $this->lang['form.input.user.completion'], ''));

		$fieldset->add_field(new FormFieldAjaxUserAutoComplete('user_completition', $this->lang['form.input.user.completion'], ''));
