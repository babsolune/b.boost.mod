...
class ClubsFormFieldColors extends AbstractFormField
{
	...
	function display()
	{
		...
		$view = new FileTemplate('clubs/fields/ClubsFormFieldColors.tpl');
	...
	public function retrieve_value()
	{
		...
		for ($i = 0; $i < $this->max_input; $i++)
		{
			...
			if ($request->has_postparameter($field_value_id))
			{
				...
				$field_name = $request->get_poststring($field_name_id) ? $request->get_poststring($field_name_id) : $request->get_poststring($field_value_id);
