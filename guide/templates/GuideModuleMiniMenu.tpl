<div class="cell-body# IF C_HORIZONTAL # inline-nav# ENDIF #">
	<nav id="guide-mini-nav" class="guide-mini-nav">
		<ul>
			# START categories #
				<li
						data-guide-id="{categories.CATEGORY_ID}"
						data-guide-parent-id="{categories.CATEGORY_PARENT_ID}"
						data-guide-order-id="{categories.CATEGORY_SUB_ORDER}"
						class="sub-cat">
...
<script>
	jQuery(document).ready(function() { 
		...
		jQuery('#guide-root-nav').menutree();
	});
</script>