...
class GuideExplorerController extends DefaultModuleController
{
		...
		foreach ($categories as $id => $category)
		{
			...
			if ($id != Category::ROOT_CATEGORY && in_array($id, $authorized_categories))
			{
                ...
                $this->view->assign_block_vars('categories', array(
                    'C_CONTROLS'            => GuideAuthorizationsService::check_authorizations()->moderation(),
	...
	private function generate_response(HTTPRequestCustom $request)
	{
        ...
        $graphical_environment->set_page_title($this->lang['guide.explorer'], $this->config->get_module_name());
