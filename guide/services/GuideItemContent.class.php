...
class GuideItemContent
{
	...
	public function get_real_summary()
	{
		...
		return TextHelper::cut_string(@strip_tags(FormatingHelper::second_parse($this->content), '<br><br/>'), (int)GuideConfig::load()->get_auto_cut_characters_number());
	}
