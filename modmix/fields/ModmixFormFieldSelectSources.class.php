<?php
/*##################################################
 *		      ModmixFormFieldSelectSources.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModmixFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modmix/fields/ModmixFormFieldSelectSources.tpl');
