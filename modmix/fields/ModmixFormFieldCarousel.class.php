<?php
/*##################################################
 *		      ModmixFormFieldCarousel.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModmixFormFieldCarousel extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modmix/fields/ModmixFormFieldCarousel.tpl');
		$tpl->add_lang(LangLoader::get('common'));
		$tpl->add_lang(LangLoader::get('common', 'modmix'));
