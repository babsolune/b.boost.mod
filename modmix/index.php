...
$url_controller_mappers = array(
	...
	new UrlControllerMapper('ModmixItemFormController', '`^/add/?([0-9]+)?/?$`', array('category_id')),
	...
	new UrlControllerMapper('ModmixDisplayItemController', '`^(?:/([0-9]+)-([a-z0-9-_]+)/([0-9]+)-([a-z0-9-_]+))/?([0-9]+)?/?$`', array('category_id', 'rewrited_name_category', 'id', 'rewrited_title', 'page')),
	...
	new UrlControllerMapper('ModmixDisplayCategoryController', '`^(?:/([0-9]+)-([a-z0-9-_]+))?/?([a-z]+)?/?([a-z]+)?/?([0-9]+)?/?([0-9]+)?/?$`', array('category_id', 'rewrited_name', 'field', 'sort', 'page', 'subcategories_page'))
);
