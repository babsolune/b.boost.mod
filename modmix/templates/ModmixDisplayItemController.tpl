<section id="module-modmix">
	<header>
		<h1>
			...
			{@modmix.module.title}# IF NOT C_ROOT_CATEGORY # - {CATEGORY_NAME}# ENDIF # # IF IS_ADMIN #<a href="{U_EDIT_CATEGORY}" title="${LangLoader::get_message('edit', 'common')}"><i class="fa fa-edit smaller"></i></a># ENDIF #
		</h1>
	</header>
	# INCLUDE NOT_VISIBLE_MESSAGE #
	<article itemscope="itemscope" itemtype="http://schema.org/Itemmix" id="article-modmix-{ID}" class="article-modmix# IF C_NEW_CONTENT # new-content# ENDIF #">
		<header>
			<h2>
			...
			<div class="more">
				...
				&nbsp;<i class="fa fa-eye" title="{VIEWS_NUMBER} {@modmix.sort.field.views}"></i>&nbsp;<span title="{VIEWS_NUMBER} {@modmix.sort.field.views}">{VIEWS_NUMBER}</span>
