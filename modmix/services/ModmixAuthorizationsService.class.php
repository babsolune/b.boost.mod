<?php
/*##################################################
 *		   ModmixAuthorizationsService.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModmixAuthorizationsService
{
	public $category_id;
	...
	{
		$auth = ModmixService::get_categories_manager()->get_heritated_authorizations($this->category_id, $bit, $mode);
