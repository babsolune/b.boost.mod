<?php
/*##################################################
 *		        ModmixCategoriesManagerController.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModmixCategoriesManagerController extends AbstractCategoriesManageController
{
	...
	{
		return ModmixUrlBuilder::display_category($category->get_id(), $category->get_rewrited_name());
	}
	...
	{
		return ModmixUrlBuilder::delete_category($category->get_id());
	}
