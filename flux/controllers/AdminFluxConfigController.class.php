...
class AdminFluxConfigController extends AdminModuleController
{
	/**
	 * @var HTMLForm
	 */
	...
	private function build_form()
	{
        ...
        $fieldset->add_field(new FormFieldSimpleSelectChoice('display_type', $this->form_lang['form.display.type'], $this->config->get_display_type(),
			array(
				new FormFieldSelectChoiceOption($this->form_lang['form.display.type.grid'], FluxConfig::GRID_VIEW, array('data_option_icon' => 'fa fa-th-large')),
				new FormFieldSelectChoiceOption($this->form_lang['form.display.type.table'], FluxConfig::TABLE_VIEW, array('data_option_icon' => 'fa fa-table'))
			),
			array(
				'select_to_list' => true,
				'events' => array('change' => '
