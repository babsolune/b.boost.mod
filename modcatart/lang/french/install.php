...
$lang['default.itemcatart.title'] = 'ModCatArt, un module générique pour PHPBoost ' . GeneralConfig::load()->get_phpboost_major_version();
$lang['default.itemcatart.description'] = '';
$lang['default.itemcatart.contents'] = 'Ce module a été conçu pour vous aider à créer des modules avec un affichage par catégories. <br />
...
<br />
Le nom du module à remplacer : <ul class="formatter-ul"><li class="formatter-li">Modcatart</li><li class="formatter-li">modcatart</li></ul>
Le nom de la classe à remplacer : <ul class="formatter-ul"><li class="formatter-li">Itemcatart</li><li class="formatter-li">itemcatart</li></ul>
<br />
