<?php
/*##################################################
 *		      ModcatartFormFieldCarousel.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatartFormFieldCarousel extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modcatart/fields/ModcatartFormFieldCarousel.tpl');
		$tpl->add_lang(LangLoader::get('common'));
		$tpl->add_lang(LangLoader::get('common', 'modcatart'));
