<?php
/*##################################################
 *		      ModcatartFormFieldSelectSources.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatartFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modcatart/fields/ModcatartFormFieldSelectSources.tpl');
