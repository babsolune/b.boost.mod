...
class ModcatartConfig extends AbstractConfigData
{
	...
	public function get_default_values()
	{
		return array(
			...
			self::ROOT_CATEGORY_DESCRIPTION => LangLoader::get_message('root_category_description', 'config', 'modcatart'),
	 ...
	 * @return ModcatartConfig
	 */
	public static function load()
	{
		return ConfigManager::load(__CLASS__, 'modcatart', 'config');
	}
	...
	{
		ConfigManager::save('modcatart', self::load(), 'config');
	}
}
?>
