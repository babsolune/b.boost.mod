<section id="module-modcatart">
	<header>
		<h1>
			...
			{@modcatart.module.title}# IF NOT C_ROOT_CATEGORY # - {CATEGORY_NAME}# ENDIF # # IF IS_ADMIN #<a href="{U_EDIT_CATEGORY}" title="${LangLoader::get_message('edit', 'common')}"><i class="fa fa-edit smaller"></i></a># ENDIF #
		</h1>
	</header>
	# INCLUDE NOT_VISIBLE_MESSAGE #
	<article itemscope="itemscope" itemtype="http://schema.org/Itemcatart" id="article-modcatart-{ID}" class="article-modcatart# IF C_NEW_CONTENT # new-content# ENDIF #">
		<header>
			<h2>
			...
			<div class="more">
				...
				&nbsp;<i class="fa fa-eye" title="{VIEWS_NUMBER} {@modcatart.sort.field.views}"></i>&nbsp;<span title="{VIEWS_NUMBER} {@modcatart.sort.field.views}">{VIEWS_NUMBER}</span>
