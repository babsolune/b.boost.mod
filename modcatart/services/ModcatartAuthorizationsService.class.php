<?php
/*##################################################
 *		   ModcatartAuthorizationsService.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatartAuthorizationsService
{
	public $category_id;
	...
	{
		$auth = ModcatartService::get_categories_manager()->get_heritated_authorizations($this->category_id, $bit, $mode);
