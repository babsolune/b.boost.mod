<?php
/*##################################################
 *		   ModcatartCategoriesFormController.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatartCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return ModcatartUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
