<section id="module-documentation" class="category-{CATEGORY_ID} single-item">
	<header class="section-header">
		<div class="controls align-right">
			...
			{@documentation.module.title}# IF NOT C_ROOT_CATEGORY # - {CATEGORY_NAME}# ENDIF #
	...
	<div class="sub-section">
		<div class="content-container">
			...
			<article itemscope="itemscope" itemtype="https://schema.org/CreativeWork" id="documentation-item-{ID}" class="documentation-item# IF C_NEW_CONTENT # new-content# ENDIF #">
				<div class="flex-between">
					<div class="more">
						...
						<div class="controls align-right">
							<a class="offload" href="{U_HISTORY}" aria-label="{@documentation.item.history}"><i class="fa fa-fw fa-clock-rotate-left" aria-hidden="true"></i></a>
							# IF C_ARCHIVE #
								# IF C_CONTROLS #
									# IF C_RESTORE #<a class="offload" href="{U_RESTORE}" aria-label="{@documentation.restore.item}"><i class="fa fa-fw fa-undo" aria-hidden="true"></i></a># ENDIF #
									# IF C_DELETE #<a href="{U_DELETE_CONTENT}" aria-label="{@documentation.delete.version}" data-confirmation="delete-element"><i class="far fa-fw fa-trash-alt" aria-hidden="true"></i></a># ENDIF #
								# ENDIF #
							# ELSE #
								# IF C_CONTROLS #
				...
				<div id="sheet-summary" class="cell-tile">
					<div class="cell-summary cell">
						<div class="cell-header">
							<h5 class="cell-name">{@documentation.summary}</h5>
						</div>
						<div class="cell-list">
