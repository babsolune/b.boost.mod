...
class DocumentationConfig extends AbstractConfigData
{
	...
	public function get_default_values()
	{
		return array(
			...
			self::ROOT_CATEGORY_DESCRIPTION             => CategoriesService::get_default_root_category_description('documentation'),
	...
	{
		return ConfigManager::load(__CLASS__, 'documentation', 'config');
	}
	...
	{
		ConfigManager::save('documentation', self::load(), 'config');
	}
}
?>
