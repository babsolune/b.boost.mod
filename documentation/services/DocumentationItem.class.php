	...
	public function get_template_vars()
	{
		...
		return array_merge(
			...
			array(
				...
				'U_DELETE'         => DocumentationUrlBuilder::delete($this->id, 0)->rel(),
