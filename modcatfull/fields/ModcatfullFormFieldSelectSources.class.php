<?php
/*##################################################
 *		      ModcatfullFormFieldSelectSources.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatfullFormFieldSelectSources extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modcatfull/fields/ModcatfullFormFieldSelectSources.tpl');
