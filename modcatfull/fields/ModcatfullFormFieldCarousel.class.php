<?php
/*##################################################
 *		      ModcatfullFormFieldCarousel.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatfullFormFieldCarousel extends AbstractFormField
{
	...
	function display()
	{
		...
		$tpl = new FileTemplate('modcatfull/fields/ModcatfullFormFieldCarousel.tpl');
		$tpl->add_lang(LangLoader::get('common'));
		$tpl->add_lang(LangLoader::get('common', 'modcatfull'));
