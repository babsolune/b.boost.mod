...
<!--
	...
	{
		var page = prompt('{@modcatfull.form.add.page.title}', '');

		if (page) {
			# IF C_TINYMCE_EDITOR #
			tinymce.activeEditor.execCommand('mceInsertContent', false, '[page]' + page + '[/page]');
			# ELSE #
			var textarea = document.getElementById('ModcatfullItemFormController_contents');
	...
	{
		var searchText = page;
		var content_input = document.getElementById('ModcatfullItemFormController_contents');
