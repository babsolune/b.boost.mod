<?php
/*##################################################
 *		   ModcatfullAuthorizationsService.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatfullAuthorizationsService
{
	public $category_id;
	...
	{
		$auth = ModcatfullService::get_categories_manager()->get_heritated_authorizations($this->category_id, $bit, $mode);
