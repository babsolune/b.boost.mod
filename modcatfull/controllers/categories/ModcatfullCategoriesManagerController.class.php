<?php
/*##################################################
 *		        ModcatfullCategoriesManagerController.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatfullCategoriesManagerController extends AbstractCategoriesManageController
{
	...
	{
		return ModcatfullUrlBuilder::display_category($category->get_id(), $category->get_rewrited_name());
	}

	protected function get_edit_category_url(Category $category)
	{
		return ModcatfullUrlBuilder::edit_category($category->get_id());
	}
