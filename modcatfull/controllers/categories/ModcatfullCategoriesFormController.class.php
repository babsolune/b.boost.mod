<?php
/*##################################################
 *		   ModcatfullCategoriesFormController.class.php
 *                            -------------------
 *   begin                : Month XX, 2017
...
class ModcatfullCategoriesFormController extends AbstractRichCategoriesFormController
{
	...
	{
		return ModcatfullUrlBuilder::add_category(AppContext::get_request()->get_getint('id_parent', 0));
	}
