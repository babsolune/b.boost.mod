...
class DocsheetModuleMiniMenu extends ModuleMiniMenu
{
	...
	{
		return 'module-mini-docsheet';
	}

	public function get_menu_title()
	{
		return LangLoader::get_message('docsheet.menu.title', 'common', 'docsheet');
	}

	public function is_displayed()
	{
		return ModulesManager::is_module_installed('docsheet') && ModulesManager::is_module_activated('docsheet');
	}

	public function get_menu_content()
	{
		$view = new FileTemplate('docsheet/DocsheetModuleMiniMenu.tpl');
		$view->add_lang(LangLoader::get_all_langs('docsheet'));
		MenuService::assign_positions_conditions($view, $this->get_block());
		Menu::assign_common_template_variables($view);
		$now = new Date();

		$categories = CategoriesService::get_categories_manager('docsheet')->get_categories_cache()->get_categories();
		$authorized_categories = CategoriesService::get_authorized_categories(Category::ROOT_CATEGORY, true, 'docsheet');
