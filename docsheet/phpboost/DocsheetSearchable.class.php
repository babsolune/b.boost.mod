...
class DocsheetSearchable extends DefaultSearchable
{
	public function __construct()
	{
		parent::__construct('docsheet');

		$this->table_name = DocsheetSetup::$docsheet_articles_table;

		$this->has_second_table = true;
		$this->second_table_name = DocsheetSetup::$docsheet_contents_table;
