...
class DocsheetConfig extends AbstractConfigData
{
	...
	{
		return array(
			self::MODULE_NAME                    => LangLoader::get_message('docsheet.module.title', 'common', 'docsheet') . ' ' . GeneralConfig::load()->get_site_name(),
			...
			self::ROOT_CATEGORY_DESCRIPTION     => LangLoader::get_message('default.root.description', 'install', 'docsheet'),
	 ...
	 * @return DocsheetConfig
	 */
	public static function load()
	{
		return ConfigManager::load(__CLASS__, 'docsheet', 'config');
	}
	...
	{
		ConfigManager::save('docsheet', self::load(), 'config');
	}
}
?>
