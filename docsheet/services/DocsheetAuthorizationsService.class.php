...
class DocsheetAuthorizationsService extends CategoriesAuthorizationsService
{
	...
	{
		$auth = CategoriesService::get_categories_manager('docsheet')->get_heritated_authorizations($this->id_category, $bit, $mode);
