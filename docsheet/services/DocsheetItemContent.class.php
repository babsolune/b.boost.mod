...
class DocsheetItemContent
{
	...
	public function get_real_summary()
	{
		...
		return TextHelper::cut_string(@strip_tags(FormatingHelper::second_parse($this->content), '<br><br/>'), (int)DocsheetConfig::load()->get_auto_cut_characters_number());
	}
	...
	{
        $this->content                      = DocsheetConfig::load()->get_default_content();
