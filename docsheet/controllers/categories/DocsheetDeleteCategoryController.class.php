...
class DocsheetDeleteCategoryController extends AbstractDeleteCategoryController
{
	...
	{
		return DocsheetService::get_categories_manager();
	}
	...
	{
		return DocsheetUrlBuilder::home();
	}
