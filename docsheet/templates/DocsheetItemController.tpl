<section id="module-docsheet" class="category-{CATEGORY_ID} single-item">
	...
	<div class="sub-section">
		<div class="content-container">
			...
			<article itemscope="itemscope" itemtype="https://schema.org/CreativeWork" id="docsheet-item-{ID}" class="docsheet-item# IF C_NEW_CONTENT # new-content# ENDIF #">
				...
				<div id="sheet-summary" class="cell-tile">
					<div class="cell-summary cell">
						<div class="cell-header">
							<h5 class="cell-name# IF C_STICKY_SUMMARY # summary-sticky# ENDIF #">{@docsheet.contents.table}</h5>
						</div>
