<section id="module-docsheet" class="several-items">
	<header class="section-header">
		<div class="controls align-right">
			<a class="offload" href="${relative_url(SyndicationUrlBuilder::rss('docsheet', ID_CAT))}" aria-label="{@common.syndication}"><i class="fa fa-rss warning" aria-hidden="true"></i></a>
		...
		<h1>
			# IF C_PENDING #
				{@docsheet.pending.items}
			# ELSE #
                # IF C_TRACKED_ITEMS #
                    {@docsheet.my.tracked}
                # ENDIF #
				# IF C_MEMBER_ITEMS #
					# IF C_MY_ITEMS #{@docsheet.my.items}# ELSE #{@docsheet.member.items} {MEMBER_NAME}# ENDIF #
				# ELSE #
            ...
            <div class="content-container">
                                    ...
                                    <tr class="category-{items.CATEGORY_ID}">
                                        ...
                                        # IF C_CONTROLS #
                                            <td class="controls">
                                                ...
                                                # ENDIF #
                                                # IF C_TRACKED_ITEMS #<a class="offload" href="{items.U_UNTRACK}" aria-label="{@docsheet.untrack}"><i class="fa fa-heart-crack error" aria-hidden="true"></i></a># ENDIF #
                                            </td>
                                        # ENDIF #
                                    </tr>
                                # END items #
                ...
                # ELSE #
                    <div class="cell-flex # IF C_GRID_VIEW #cell-columns-{ITEMS_PER_ROW}# ELSE #cell-row# ENDIF #">
                        # START items #
                            <article id="docsheet-item-{items.ID}" class="docsheet-item category-{items.CATEGORY_ID} cell# IF items.C_NEW_CONTENT # new-content# ENDIF #" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
